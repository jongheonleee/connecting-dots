...
//
//            var bestViewBoardDto = createBestViewBoardDto(boardDto.getBno());
...
//        assertEquals(1, target.insert(bestViewBoardDto));
//
//        Integer seq = bestViewBoardDto.getSeq();
...
//        assertEquals(1, target.update(bestViewBoardUpdateDto));
//
//        var foundDto = target.select(bestViewBoardUpdateDto.getSeq());
//        assertNotNull(foundDto);
//        log.info("foundDto: {}", foundDto);
//    }
//
...
//
//        var bestViewBoardDto = createBestViewBoardDto(boardDto.getBno());
//        bestViewBoardDto.setAppl_begin("2024-08-01");
//        bestViewBoardDto.setAppl_end("2024-09-01");
//        assertEquals(1, target.insert(bestViewBoardDto));
//
//        var bestViewBoardUpdateDto = createBestViewBoardUpdateDto(bestViewBoardDto.getSeq());
...
//        assertEquals(1, boardDao.insert(boardDto));
//
//        var bestLikeBoardDto = createBestViewBoardDto(boardDto.getBno());
...
//    }
//
//    private BestViewBoardDto createBestViewBoardDto(Integer bno) {
//        var dto = new BestViewBoardDto();
//        dto.setBno(bno);
...
//    }
//
//    private BestViewBoardUpdateDto createBestViewBoardUpdateDto(Integer seq) {
//        var dto = new BestViewBoardUpdateDto();
//
//        dto.setSeq(seq);
//        dto.setAppl_begin("2025-01-01");
//        dto.setAppl_end("2025-02-01");
