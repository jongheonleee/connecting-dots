...
> - 1️⃣ TDD 개발을 통해 효율적이며 목적지향적으로 프로그래밍 하는 방식   
> - 2️⃣ RDB 대규모 설계시 테스트 작성의 복잡도 증가하게 되며 이를 적절히 대처해야 한다.
> - 3️⃣ 서비스 정책을 RDB에 적절히 쪼개서 테이블로 정의하면 동적으로 생성할 수 있다.
> - 4️⃣ 단위·통합·학습 테스트 작성을 통한 테스트 코드 포괄적으로 활용 
> - 5️⃣ 성능 개선을 위한 SQL 튜닝
...
### 📌  Oracle를 튜닝 방법을 기준으로 쿼리 작성을 했습니다.(실제 적용된 SQL은 MySQL) 
